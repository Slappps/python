...
class Test:
    ...
    def test_mute(self):
        ...
        self.tv1.power()
        self.tv1.mute()
        assert self.tv1.__str__() == 'Power = False, Channel = 0, Volume = 1' #tv is off and muted, should volume be 0?

        self.tv1.mute()
        assert self.tv1.__str__() == 'Power = False, Channel = 0, Volume = 1'  # tv is off and unmuted, should volume be 0?
    ...
    def test_volume_up(self):
        ...
        self.tv1.volume_up() # vol now 3, max is 2
        assert self.tv1.__str__() == 'Power = True, Channel = 0, Volume = 2'
